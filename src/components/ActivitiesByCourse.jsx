...
const ActivitiesByCourse = () => {
  ...
  const getActivities = async () => {
    const response = await fetch(
      `https://schoolinfoserver.onrender.com/activities/${courseId}/course`, 
      {
        method: "GET",
  ...
  const handleDelete = async (activityId) => {
    const response = await fetch(
      `https://schoolinfoserver.onrender.com/activities/${activityId}/delete`,
      {
        method: "DELETE",
        headers: {
    ...
    .map((activity) => (
      <tr key={activity._id}>
        ...
        <div className="flex justify-center space-x-2">
          <button
            className="bottonstu  bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-2"
            ...
            <div className="bg-white p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
              ...
              <div className="flex flex-col sm:flex-row mb-4">
                ...
                <input
                  ...
                  className="mb-4 sm:mb-0 sm:mr-4 px-4 py-2 border rounded w-full sm:w-auto"
                />
                <button
