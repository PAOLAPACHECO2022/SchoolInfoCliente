...
const ActivitiesByCourse = () => {
    ...
    const getActivities = async () => {
        const response = await fetch(`https://schoolinfoserver.onrender.com/activities/${courseId}/course`, {
            method: "GET",
    ...
    const handleDelete = async (activityId) => {
        const response = await fetch(`https://schoolinfoserver.onrender.com/activities/${activityId}/delete`, {
            method: "DELETE",
            headers: {
    ...
    const activitiesToDisplay = filteredActivities.slice(offset, offset + PER_PAGE).map((activity) => (
        <tr key={activity._id}>
